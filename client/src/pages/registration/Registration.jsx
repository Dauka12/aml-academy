...
const SelectField = ({ name, label, selectItems, formData, handleChange, icon: Icon }) => {
...
const InputField = ({ name, label, hint, isPassword, formData, handleChange, required, icon: Icon, type = "text" }) => {
