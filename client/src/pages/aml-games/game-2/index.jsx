...
const GameReader = () => {
    ...
    const isResultPage = (subLevel === '6' && level === '1') || (subLevel === '5' && level === '2') || (subLevel === '2' && level === '3') || (subLevel === '2' && level === '4');
    ...
    return (
        <Provider store={storeGame}>
            <div>
                ...
                <TransitionGroup>
                    <CSSTransition
                        key={location.key} // Используем ключ, чтобы различать разные страницы
                        classNames="fade"
                        timeout={550} // Время для анимации
                    >
                        {!isResultPage ? (
