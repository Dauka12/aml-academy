        ...
        },
        {
            ...
            content: (
                <div>
                    <h2>Определение рисков по продуктам и услугам</h2>
                    <p>
                        Задание: Вам предстоит определить вид операции, тносящейся к деятельности ювелирного сектора и указать пороговые значение установленную Законом о ПОД/ФТ
                    </p>
