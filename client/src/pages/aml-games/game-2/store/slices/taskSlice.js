        ...
        },
        {
            ...
            content: (
                <div>
                    <h2>Определение рисков по продуктам и услугам</h2>
                    <p>
                        Задание: Вам предстоит определить вид операции, относящейся к деятельности ювелирного сектора и указать <span class="bold">ПОРОГОВОЕ</span> значение установленную Законом о ПОД/ФТ
                    </p>
