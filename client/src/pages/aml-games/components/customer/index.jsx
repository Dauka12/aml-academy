            ...
            {customer.map((customer, index) => (
                <div key={index} className="customer-item">
                    <div className="customer-info">
                        <img src={customer.avatar || 'default-avatar.png'} alt="avatar" className="customer-avatar" />
                        <div className="customer-name">{customer.name}</div>
                    </div>
                    <div className="operation-select">
                        <div className="operation-selector" onClick={() => toggleDropdown(index)}>
                        ...
                        {openDropdownIndex === index && (
                            <div className="operation-dropdown">
                                <div 
                                    ...
                                    onClick={() => handleSelectOperation('пороговые операции', index)}
                                >
                                    пороговые операции
                                </div>
                                <div 
                                    className="operation-option"
                                    onClick={() => handleSelectOperation('подозрительные операции', index)}
                                >
