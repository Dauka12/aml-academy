    ...
    <>
      ...
      <Box
        ...
        sx={{
          ...
          position: "relative",
          background:
            "linear-gradient(135deg, #f9f7f4 0%, #f5f3f0 50%, #f0eee9 100%)",
          justifyContent: "center",
          overflow: "hidden",
          pt: { xs: 10, md: 8 },
          pb: { xs: 5, md: 8 },
      ...
      >
        <Helmet>
          ...
          <meta
            name="description"
            content="IT решения от AML Academy для эффективного управления рисками и соответствия требованиям"
          />
        </Helmet>
        ...
        >
          ...
          >
            ...
            >
              Инновационные технологические решения для финансового мониторинга
                ...
                >
                  ...
                  <Card
                    sx={{
                      ...
                      "&:hover": {
                        background:
                          "linear-gradient(135deg, #faf8f5 0%, #f0eee9 100%)",
                        transform: "translateY(-4px)",
                        boxShadow: "0 8px 30px rgba(0,0,0,0.1)",
                        border: "1px solid rgba(59, 130, 246, 0.25)",
                        "&::before": {
