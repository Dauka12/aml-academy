      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6}>
          <FormControl fullWidth error={!!formErrors.audience}>
            ...
            >
              ...
              <MenuItem value="Государственные органы-регуляторы">
                Государственные органы-регуляторы
              </MenuItem>
              <MenuItem value="Субъект финансового мониторнга">
                Субъект финансового мониторнга
              </MenuItem>
              <MenuItem value="Правоохранительные">
                Правоохранительные органы
              </MenuItem>
              <MenuItem value="Общественное объединение">
                Общественное объединение
              </MenuItem>
              <MenuItem value="Для всех субъектов">Для всех субъектов</MenuItem>
            </Select>
            {formErrors.audience && (
              <FormHelperText>{formErrors.audience}</FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid item xs={12} sm={6}>
          <FormControl fullWidth error={!!formErrors.lang}>
            ...
            {formErrors.lang && (
              <FormHelperText>{formErrors.lang}</FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            value={academicHours}
            onChange={(e) =>
              setAcademicHours(Math.max(0, parseInt(e.target.value) || 0))
            }
        ...
        <Grid item xs={12} sm={6}>
          <FormControl fullWidth error={!!formErrors.typeOfStudy}>
            ...
            {formErrors.typeOfStudy && (
              <FormHelperText>{formErrors.typeOfStudy}</FormHelperText>
            )}
          </FormControl>
        </Grid>
      </Grid>
